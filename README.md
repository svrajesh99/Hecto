...
```
cd existing_repo
git remote add origin https://gitlab.com/sreenivasan_ab/hekto.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sreenivasan_ab/hekto/-/settings/integrations)
